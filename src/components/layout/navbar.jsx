                    ...
                    {isMobileMenuOpen && (
                        <div className="absolute top-12 right-0 w-56 bg-white border rounded-md shadow-lg p-4 z-10">
                            <ul className="space-y-2 text-mainBlue font-medium">
                                ...
                                {!user && (
                                    <li>
                                        <Link href="/auth/signin" className="block bg-orange-500 hover:bg-orange-600 hover:font-bold text-white w-full px-8 h-10 rounded-lg flex items-center justify-center">
                                            <FaUser className="mr-2" /> Sign In
                                        </Link>
                                    </li>
                                )}
