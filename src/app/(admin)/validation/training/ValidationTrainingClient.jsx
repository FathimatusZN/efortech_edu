...
import ExportCancelledDialog from "@/components/admin/ExportCancelledDialog";
                      ...
                      {currentConfig.filters?.attendance_status?.map(
                        (attendanceStatus) => (
                          ...
                          >
                              ...
                              onCheckedChange={(checked) => {
                                setSelectedFilters((prev) => {
                                  ...
                                  const prevAttendance =
                                    prevAttendanceFilter.attendance_status ||
                                    [];
                            ...
                            />
                            <label
                              htmlFor={`attendance-status-${attendanceStatus}`}
                            >
