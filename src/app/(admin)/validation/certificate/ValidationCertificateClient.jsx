  ...
  const handleAdminSubmit = async (data) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/ucertificate/create-by-admin`,
        {
          method: "POST",
          headers: {
                    ...
                    <div className="mb-20">
                      ...
                      <SuccessDialog
                        ...
                        messages={[
                          ...
                          "Uploaded certificate were automatically validated and saved.",
                        ]}
                      />
                    </div>
                  </TabsContent>
...
export default ValidationCertificateClient;
