...
const CertificateClient = () => {
  ...
  const buildQueryParams = () => {
    ...
    const urlObj = new URL(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}${config.url}`
    );
  ...
  useEffect(() => {
    ...
    searchQuery,
    JSON.stringify(selectedFilters[tab]),
    sortBy,
    sortOrder,
    tab,
  ]);
          ...
          <div className="bg-white overflow-hidden">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-4">
              <TabsList className="flex flex-wrap gap-2">
                <TabsTrigger value="allcertificate">
                  All Certificates
                </TabsTrigger>
                <TabsTrigger value="trainingcertificate">
                  Training Registration Certificates
                </TabsTrigger>
                <TabsTrigger value="useruploadcertificate">
                  User Upload Certificates
                </TabsTrigger>
              </TabsList>
                        ...
                        (statusCode) => (
                          ...
                          >
                            <Checkbox
                              ...
                              checked={
                                selectedFilters[tab].validity_status?.includes(
                                  statusCode
                                ) || false
                              }
